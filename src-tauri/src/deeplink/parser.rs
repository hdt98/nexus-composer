...
//!
//! Parses nexus:// URL (backward compat with ccswitch://)s into DeepLinkImportRequest structures.
...
/// Parse a nexus:// URL (backward compat with ccswitch://) into a DeepLinkImportRequest
///
/// Expected format:
/// nexus://v1/import (or ccswitch:// for backward compat)?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "ccswitch" && scheme != "nexus" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'nexus' or 'ccswitch', got '{scheme}'"
        )));
    }
